...
<html>
    ...
    <ul class="clearfix menu-nav-list" scroll-position-static="160">
        <li class="no-line "><a href="<?php echo e(URL('/shop_intro')); ?>">餐厅介绍</a></li>
        <li class="active"><a href="<?php echo e(URL('/shop_detail')); ?>">菜单</a></li>
        <li ><a href="<?php echo e(URL('/shop_comment')); ?>">评论</a></li>
            <li ><a href="<?php echo e(URL('/shop_order')); ?>" id='point-tab'>大家都在点</a></li>
                ...
                <aside class="fl">
                    <article class="cart" scroll-position-static="160" top="42">
                        <div class="menu-cart">
                            ...
                            <section>
                                <form class="inner-cart empty" ng-class="{empty:isEmpty}" method="POST" action="<?php echo e(URL('/order')); ?>">
