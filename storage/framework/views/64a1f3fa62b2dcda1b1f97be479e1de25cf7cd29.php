            ...
            <div class="order-list ">
                 ...
                 <div class="order-bd clearfix">
                    <div class="fl restaurant-msg">
                         <div>
                             <img src="<?php echo e(asset('/Shop')); ?><?php echo e($l->photo); ?>" alt="" class="fl" height="43" width="43">
                             <i class="fl"><?php echo e($l->name); ?></i>
                         </div>
                         <p class="clearfix">
                            <i class="fl"></i>
                            <span class="fl">餐厅电话：<?php echo e($l->phone); ?></span>
                        </p>
                    </div>
                     <div class="fl order-type padding-margin">
                         <p>订单类型：<?php echo e(($l->type)==1?"餐到付款":""); ?></p>
                         <p class="sh">订单状态：<?php echo e(($l->express)==2?"送货成功":"路途当中"); ?></p>
                     </div>
                     <div class="fl order-total padding-margin">
                         <p>订单金额</p>
                         <p><i>￥<?php echo e($l->money); ?></i></p>
                     </div>
                     <div class="order-operate fl padding-margin">
                        <p>
                            <a href="javascript:;" oid="<?php echo e($l->bid); ?>" data-name="<?php echo e($l->name); ?>" success-review="" class="btn btn-order success-review pl">评论</a>　<i  class="btn btn-order success-review cs">删除</i><i  class="btn btn-order success-review qr">确认收货</i>
                        </p>
                        <p>
                    ...
                    <div class="" id="tid">
                        <div class="order-menu-info fl">
                            <div class="order-menu-inner">
                                ...
                                <div class="cart-body">
                                    <?php $__currentLoopData = $str; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <?php $__currentLoopData = $st; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <?php if($s->oid == $l->id): ?>
                                    <div class="cart-item clearfix ng-scope">
                                        <div class="goods-name ellipsis ng-binding" ><?php echo e($s->cname); ?></div>
                                        <div class="goods-count ellipsis ng-binding"><?php echo e($s->num); ?></div>
                                        <div class="goods-price ng-binding" >￥<?php echo e($s->Price); ?></div>
                                        <div class="goods-subtotal ng-binding" >￥<?php echo e($s->Price*$s->num); ?></div>     
                                ...
                                <div class="cart-footer clearfix">
                                    <div class="order-adress fl">
                                        ...
                                        <div><label for="">送餐电话：</label><span class="ng-binding"><?php echo e($l->sphone); ?></span></div>
                                        <div class="clearfix">
                                            <label for="" class="fl">送餐地址：</label>
                                            <p class="fl ng-binding" ><?php echo e($l->address); ?></p>
                                        </div>
                                    ...
                                    <div class="total fr">
                                        ...
                                        <p class="order-total">实付金额：<?php echo e($l->money); ?><span ng-bind="order['11982902'].order_total|currency:'￥'" class="ng-binding"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
