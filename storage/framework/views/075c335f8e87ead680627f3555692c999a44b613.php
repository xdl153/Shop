...
<div class="page-container">
	...
	<div class="text-c">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
			<?php $__currentLoopData = $li; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
				<tr id="a<?php echo e($p->id); ?>" class="text-c">
					<th width="25"><input type="checkbox" name="" value=""></th>
					<td ><?php echo e($p->id); ?></td>
					<td><?php echo e($p->phone); ?></td>
					<td><?php echo e($p->data); ?></td>
					<td><?php echo e($p->content); ?></td>
                                        <td><span onclick="operation(<?php echo e($p->id); ?>);">删除</span></td>
				</tr>
