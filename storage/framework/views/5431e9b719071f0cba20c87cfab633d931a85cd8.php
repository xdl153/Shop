...
<div class="page-container">
	...
	<p>地址：<?php echo e(session('adminuser')->address); ?></p>
	...
	<table class="table table-border table-bordered table-bg mt-20">
		...
		<tbody>
			<tr>
				<th width="30%">登录名</th>
				<td><span id="lbServerName"></span><?php echo e(session('adminuser')->name); ?></td>
			</tr>
			<tr>
				<td>邮箱</td>
				<td><?php echo e(session('adminuser')->email); ?></td>
			</tr>

			<tr>
				<td>手机号</td>
				<td><?php echo e(session('adminuser')->phone); ?></td>
			</tr>
		</tbody>
	</table>
</div>
