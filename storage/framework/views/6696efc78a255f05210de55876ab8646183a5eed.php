  ...
  <table class="table" style="margin-left:-400px;margin-top:100px;">
    <tbody>
      <tr>
        ...
        <td style="font-size:20px;color:red;"><?php echo e(session('adminuser')->name); ?></td>
      </tr>
      <tr>
        <th class="text-r" style="font-size:20px;">邮箱：</th>
        <td style="color:pink"><?php echo e(session('adminuser')->email); ?></td>
      </tr>
      <tr>
        <th class="text-r" style="font-size:20px;">地址：</th>
        <td style="color:blue"><?php echo e(session('adminuser')->address); ?></td>
      </tr>
      <tr>
        <th class="text-r" style="font-size:20px;">电话：</th>
        <td style="color:yellow"><?php echo e(session('adminuser')->phone); ?></td>
      </tr>
      <div><a style="font-size:50px;color:#cccc;" href="<?php echo e(URL('Admin/index')); ?>">Home</a></div>
