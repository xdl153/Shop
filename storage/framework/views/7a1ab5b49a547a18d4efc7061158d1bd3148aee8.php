...
<div class="page-container">
		<center>
		<table class="table table-border table-bordered table-hover table-bg table-sort" style='width:600px;'>
			<thead>
				<tr class="text-c">
					<th width="80">ID</th>
					<th>类别名称</th>
			...
			<tbody>
				...
				<tr class="text-c" >
					...
					<td class="text-l" ><?php echo e($cat->name); ?></td>
					<td class="f-14">
						<a title="编辑" href="javascript:;" onclick="system_category_edit('分类编辑','category-upd?id=<?php echo e($cat->id); ?>','1','300','400')" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="删除" href="javascript:;" onclick="article_category_del(this,'<?php echo e($cat->id); ?>')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
