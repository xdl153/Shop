...
<html>
	...
	<body class="day " ng-controller="bodyCtrl"  day-or-night>
        ...
        <div class="order-list ">
             <div class="order-hd">
                <span><i>订单编号：</i>D-11982902</span><i>创建时间：</i>2016-10-11 21:47:53
             </div>
             <div class="order-bd clearfix">
                 <div class="fl restaurant-msg">
                     <div>
                         <img src="http://dhcrestaurantlogo.dhero.cn/25848?v=1430358243" alt="" class="fl" height="43" width="43">
                         <i class="fl">豪大大鸡排鞍山支路店</i>
                     </div>
                     <p class="clearfix">
                        <i class="fl"></i>
                        <span class="fl">餐厅电话：13122457785, 18252838816</span>
                    </p>
                 </div>
             ...
             <div class="order-details clearfix">
                ...
                <div ng-hide="orderStatus['11982902']" class="" id="tid">
                    <div class="order-menu-info fl">
                        <div class="order-menu-inner">
                            ...
                            <div class="cart-body">
                                    <!-- ngRepeat: menu_item in order['11982902'].menu_items_data -->
                                    <!-- ngRepeat: add_item in order['11982902'].total_additions -->
                                    <!-- ngRepeat: activity in order['11982902'].activities -->
                            </div>
                            <div class="cart-footer clearfix">
                                <div class="order-adress fl">
                                    <!-- ngIf: order['11982902'].preorder_time -->
                                    <div><label for="">送餐电话：</label><span ng-bind="order['11982902'].customer_phone" class="ng-binding"></span></div>
                                    <div class="clearfix">
                                        <label for="" class="fl">送餐地址：</label>
                                        <p class="fl ng-binding" ng-bind="order['11982902'].address_text"></p>
                                    </div>
        ...
        <div class="order-list ">
             <div class="order-hd">
                <span><i>订单编号：</i>D-11982526</span><i>创建时间：</i>2016-10-10 18:07:10
             </div>
             <div class="order-bd clearfix">
                 <div class="fl restaurant-msg">
                     <div>
                 ...
                 <div class="order-operate fl padding-margin">
                    ...
                    <p>
                        <a href="javascript:" order-number="" orderid="11982526" class="btn_a see-details">查看详情<i></i></a>
                    </p>
                 </div>
             </div>
             <div class="order-details clearfix">
                <div ng-hide="orderStatus['11982526']" class="order-loading">
                    <span ng-show="orderStatus['11982526_error']" class="order-hide ng-hide">访问出错，请重新加载！</span>
                </div>
                <div ng-show="orderStatus['11982526']" class="ng-hide">
                    <div class="order-menu-info fl">
                        <div class="order-menu-inner">
                            <div class="cart-thead clearfix">
                                <div class="goods-name">商品</div>
                            ...
                            <div class="cart-body">
                                    <!-- ngRepeat: menu_item in order['11982526'].menu_items_data -->
                                    <!-- ngRepeat: add_item in order['11982526'].total_additions -->
                                    <!-- ngRepeat: activity in order['11982526'].activities -->
                            </div>
                            <div class="cart-footer clearfix">
                                <div class="order-adress fl">
                                    <!-- ngIf: order['11982526'].preorder_time -->
                                    <div><label for="">送餐电话：</label><span ng-bind="order['11982526'].customer_phone" class="ng-binding"></span></div>
                                    <div class="clearfix">
                                        <label for="" class="fl">送餐地址：</label>
                                        <p class="fl ng-binding" ng-bind="order['11982526'].address_text"></p>
                                    </div>
                                    <!-- ngIf: order['11982526'].comment -->
                                </div>
                                <div class="total fr">
                                    <p>配送费：<span ng-bind="order['11982526'].delivery_fee|currency:'￥'" class="ng-binding"></span></p>
                                    <!-- ngIf: order['11982526'].coupon_amount -->
                                    <!-- ngIf: order['11982526'].red_packet_amount -->
                                    <!-- <p>活动优惠：<span ng-bind="order['11982526'].total_remit_amount|currency:'￥'"></span></p> -->
                                    <p class="order-total">实付金额：<span ng-bind="order['11982526'].order_total|currency:'￥'" class="ng-binding"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="order-logistics fl">
                        <!-- ngRepeat: workflow in order['11982526'].status_workflow --> 
                    </ul>
                </div>
             </div>
         </div>
        ...
        <div class="order-list ">
             <div class="order-hd">
                <span><i>订单编号：</i>D-11982493</span><i>创建时间：</i>2016-10-10 16:42:38
             </div>
             <div class="order-bd clearfix">
                 <div class="fl restaurant-msg">
                     <div>
                         <img src="http://dhcrestaurantlogo.dhero.cn/25599?v=1436262738" alt="" class="fl" height="43" width="43">
                         <i class="fl">意士多手工披萨（龙吴路）</i>
                     </div>
                     <p class="clearfix">
                        <i class="fl"></i>
                        <span class="fl">餐厅电话：18115502949, 18701953378</span>
                    </p>
                 </div>
                 <div class="fl order-type padding-margin">
                     <p>订单类型：餐到付款</p>
                 ...
                 <div class="order-operate fl padding-margin">
                            ...
                            <p><a href="javascript:;" oid="11982493" data-name="意士多手工披萨（龙吴路）" success-review="" class="btn btn-order review">去评论</a></p>
                         
                    
                    
                    
                    <p>
                        <a href="javascript:" order-number="" orderid="11982493" class="btn_a see-details">查看详情<i></i></a>
                    </p>
                 </div>
             </div>
             <div class="order-details clearfix">
                <div ng-hide="orderStatus['11982493']" class="order-loading">
                    <span ng-show="orderStatus['11982493_error']" class="order-hide ng-hide">访问出错，请重新加载！</span>
                </div>
                <div ng-show="orderStatus['11982493']" class="ng-hide">
                    <div class="order-menu-info fl">
                        <div class="order-menu-inner">
                            <div class="cart-thead clearfix">
                                <div class="goods-name">商品</div>
                            ...
                            <div class="cart-body">
                                    <!-- ngRepeat: menu_item in order['11982493'].menu_items_data -->
                                    <!-- ngRepeat: add_item in order['11982493'].total_additions -->
                                    <!-- ngRepeat: activity in order['11982493'].activities -->
                            </div>
                            <div class="cart-footer clearfix">
                                <div class="order-adress fl">
                                    <!-- ngIf: order['11982493'].preorder_time -->
                                    <div><label for="">送餐电话：</label><span ng-bind="order['11982493'].customer_phone" class="ng-binding"></span></div>
                                    <div class="clearfix">
                                        <label for="" class="fl">送餐地址：</label>
                                        <p class="fl ng-binding" ng-bind="order['11982493'].address_text"></p>
                                    </div>
                                    <!-- ngIf: order['11982493'].comment -->
                                </div>
                                <div class="total fr">
                                    <p>配送费：<span ng-bind="order['11982493'].delivery_fee|currency:'￥'" class="ng-binding"></span></p>
                                    <!-- ngIf: order['11982493'].coupon_amount -->
                                    <!-- ngIf: order['11982493'].red_packet_amount -->
                                    <!-- <p>活动优惠：<span ng-bind="order['11982493'].total_remit_amount|currency:'￥'"></span></p> -->
                                    <p class="order-total">实付金额：<span ng-bind="order['11982493'].order_total|currency:'￥'" class="ng-binding"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="order-logistics fl">
                        <!-- ngRepeat: workflow in order['11982493'].status_workflow --> 
                    </ul>
                </div>
             </div>
         </div>
         
        <div class="order-list order-faild">
             <div class="order-hd">
                <span><i>订单编号：</i>D-11982490</span><i>创建时间：</i>2016-10-10 16:39:55
             </div>
             <div class="order-bd clearfix">
                 <div class="fl restaurant-msg">
                     <div>
                         <img src="http://dhcrestaurantlogo.dhero.cn/16412?v=1449467806" alt="" class="fl" height="43" width="43">
                         <i class="fl">快乐家族</i>
                     </div>
                     <p class="clearfix">
                        <i class="fl"></i>
                        <span class="fl">餐厅电话：15802149029</span>
                    </p>
                 </div>
                 <div class="fl order-type padding-margin">
                     <p>订单类型：餐到付款</p>
                 ...
                 <div class="order-operate fl padding-margin">
                    ...
                    <p>
                        <a href="javascript:" order-number="" orderid="11982490" class="btn_a see-details">查看详情<i></i></a>
                    </p>
                 </div>
             </div>
             <div class="order-details clearfix">
                <div ng-hide="orderStatus['11982490']" class="order-loading">
                    <span ng-show="orderStatus['11982490_error']" class="order-hide ng-hide">访问出错，请重新加载！</span>
                </div>
                <div ng-show="orderStatus['11982490']" class="ng-hide">
                    <div class="order-menu-info fl">
                        <div class="order-menu-inner">
                            <div class="cart-thead clearfix">
                                <div class="goods-name">商品</div>
                            ...
                            <div class="cart-body">
                                    <!-- ngRepeat: menu_item in order['11982490'].menu_items_data -->
                                    <!-- ngRepeat: add_item in order['11982490'].total_additions -->
                                    <!-- ngRepeat: activity in order['11982490'].activities -->
                            </div>
                            <div class="cart-footer clearfix">
                                <div class="order-adress fl">
                                    <!-- ngIf: order['11982490'].preorder_time -->
                                    <div><label for="">送餐电话：</label><span ng-bind="order['11982490'].customer_phone" class="ng-binding"></span></div>
                                    <div class="clearfix">
                                        <label for="" class="fl">送餐地址：</label>
                                        <p class="fl ng-binding" ng-bind="order['11982490'].address_text"></p>
                                    </div>
                                    <!-- ngIf: order['11982490'].comment -->
                                </div>
                                <div class="total fr">
                                    <p>配送费：<span ng-bind="order['11982490'].delivery_fee|currency:'￥'" class="ng-binding"></span></p>
                                    <!-- ngIf: order['11982490'].coupon_amount -->
                                    <!-- ngIf: order['11982490'].red_packet_amount -->
                                    <!-- <p>活动优惠：<span ng-bind="order['11982490'].total_remit_amount|currency:'￥'"></span></p> -->
                                    <p class="order-total">实付金额：<span ng-bind="order['11982490'].order_total|currency:'￥'" class="ng-binding"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="order-logistics fl">
                        <!-- ngRepeat: workflow in order['11982490'].status_workflow --> 
                    </ul>
                </div>
             </div>
         </div>
		...
		<script src="<?php echo e(asset('Shop/js/jquery-1.8.1.js')); ?>"></script>
		<script src="<?php echo e(asset('Shop/js/jquery.uploadify.min.js')); ?>"></script>
