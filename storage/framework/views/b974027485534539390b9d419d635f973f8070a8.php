  ...
  <table class="table" style="margin-left:-400px;margin-top:100px;">
    <tbody>
      ...
      <tr>
        ...
        <td style="font-size:20px;color:pink"><?php echo e(session('adminuser')->regitime); ?></td>
      </tr>
      <div><a style="font-size:50px;color:yellow;" href="<?php echo e(URL('Admin/index')); ?>">Home</a></div>
    </tbody>
  </table>
</div>
</div>
