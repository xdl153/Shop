...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('Shop/css/confirm.css')); ?>"/>
        ...
        <section class="common-back" id="wrapBackground">
            ...
            <div class="confirm-content fl">
                <div class="content">
                    ...
                    <p><h4>请保持手机<?php echo e(session('username')); ?>畅通，稍后超人客服或餐厅会与您联系。</h4></p>
                    <?php else: ?>
            ...
            <div class="app_download fl">
                <h4>下载外卖超人手机App</h4>
                <p>用手机扫描下方二维码</p>
                <p><img src="<?php echo e(asset('Shop/images/confirm_code.png')); ?>" alt="App二维码" class="code-img"/></p>
                <p>或电脑直接下载</p>
                <div class="down-btn">
                ...
                <div class="chaoren-weixin">
                    <img src="<?php echo e(asset('Shop/images/confirm_code_small.png')); ?>" class="code-img"/>
    ...
    <script src="<?php echo e(asset('Shop/js/confirm.js')); ?>"></script>
