...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('Shop/css/reset.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('Shop/css/common.css')); ?>"/>
        <link rel="stylesheet" href="<?php echo e(asset('Shop/css/forget_passwd.css')); ?>"/>

        <!--[if lt IE 9]><link rel="stylesheet" type="text/css" href="<?php echo e(asset('Shop/css/frontPage-ie8-fix.css')); ?>" /><![endif]-->
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo e(asset('Shop/js/jquery-1.7.2.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('Shop/js/forget_passwd.js')); ?>"></script>
