...
<div class="page-container">
	...
	<div class="text-c">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<?php $__currentLoopData = $business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			<tbody>
				<tr class="text-c">
					<td width="25"><input type="checkbox" name="" value=""></td>
					<td><?php echo e($p->id); ?></td>
					<td><?php echo e($p->name); ?></td>
					<td><img src="Shop/<?php echo e($p->photo); ?>" width="80" height="100"></td>
					<td><?php echo e($p->dname); ?></td>
					<td><?php echo e($p->dphone); ?></td>
					<td><?php if($p->examine == 1): ?> 审核中 <?php elseif($p->examine == 2): ?> 审核通过 <?php else: ?> 审核不通过 <?php endif; ?> </td>
					<td>
						<a style="text-decoration:none" class="ml-5 tj"  href="javascript:fun(<?php echo e($p->id); ?>);" title="通过审核">
                           <i class="Hui-iconfont">&#xe6e1;</i>
                        </a>
                        <a style="text-decoration:none" class="ml-5 tj"  href="javascript:fun1(<?php echo e($p->id); ?>);" title="审核不通过">
                            <i class="Hui-iconfont">&#xe6dd;</i>
                        </a>
                    </td>
				</tr>
