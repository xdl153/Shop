	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">商家后台系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml"></a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 编辑<i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="picture_add('修改密码','<?php echo e(URL('dealer-password')); ?>')"><i class="Hui-iconfont">&#xe613;</i> 密码</a></li>
							<li><a href="javascript:;" onclick="product_add('添加菜品','<?php echo e(URL('menu-brand')); ?>')"><i class="Hui-iconfont">&#xe620;</i> 菜品</a></li>
							<li><a href="javascript:;" onclick="member_add('添加店铺','<?php echo e(URL('business-brand')); ?>','','510')"><i class="Hui-iconfont">&#xe60d;</i> 店铺</a></li>
						</ul>
					</li>
				</ul>
			</nav>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li><?php echo e(session('businessuserid')->name); ?></li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">欢迎登录商家后台 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
							<li><a href="<?php echo e(URL('Business/logout')); ?>">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(URL('dealer-password')); ?>" data-title="更改密码" href="javascript:void(0)">更改密码</a></li>
					<li><a _href="<?php echo e(URL('dealer-phone')); ?>" data-title="更改电话" href="javascript:void(0)">更改电话</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(URL('business-info')); ?>" data-title="店铺信息" href="javascript:void(0)">店铺信息</a></li>
					<li><a _href="<?php echo e(URL('/business-brand')); ?>" data-title="新增店铺" href="javascript:void(0)">新增店铺</a></li>
</ul>
			</dd>
		</dl>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(URL('/orderform-list')); ?>?id=<?php echo e(session('businessuserid')->id); ?>" data-title="订单列表" href="javascript:void(0)">订单列表</a></li>
					<li><a _href="<?php echo e(URL('/orderform-unfinished')); ?>?id=<?php echo e(session('businessuserid')->id); ?>" data-title="未完成订单" href="javascript:void(0)">未完成订单</a></li>
                                        <li><a _href="<?php echo e(URL('/orderform-accomplish')); ?>?id=<?php echo e(session('businessuserid')->id); ?>" data-title="已完成订单" href="javascript:void(0)">已完成订单</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="<?php echo e(URL('Business/welcome')); ?>">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo e(URL('Business/welcome')); ?>"></iframe>
		</div>
	</div>
</section>
