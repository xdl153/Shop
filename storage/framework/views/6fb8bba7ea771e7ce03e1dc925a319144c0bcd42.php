...
<html>
	<head>
		...
		<link rel="icon" type="image/png" href="<?php echo e(asset('Shop/images/favicon.ico')); ?>"/>
		...
		<link rel="stylesheet" href="<?php echo e(asset('Shop/css/frontPage.css')); ?>"/>
		
		<link rel="stylesheet" href="<?php echo e(asset('Shop/css/reveal.css')); ?>">
		<style type="text/css">
		...
		<title><?php echo e(session('system')->name); ?></title>
	</head>
				...
				<div class="city-list-box back-yellow">
					<div class="dropdown-box">
						<div class="dropdown-select">
							<span class="dropdown-text" id="cityName" cityName="Shanghai"><?php $__currentLoopData = $district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?><?php echo e($list->name); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?></span>
							<span class="caret"></span>
							<input type="hidden" id="inputid" value=" <?php $__currentLoopData = $district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?><?php echo e($list->id); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?> " >
						</div>
							...
							<div class="search-box search-box-border">
								...
								<div class="hot-area clearfix fs12">
										...
										<ul class="fl clearfix">
											<?php $__currentLoopData = $town; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<li><a href="/shop_list?id=<?php echo e($info->id); ?>" > <?php echo e($info->name); ?></a></li>
		...
		<section class="brand-restaurant-box ">
			...
			<div class="footer-last">
				...
				<div class="tc fs14 light-gray mb10" style="color:#ccc;font-size:20px;">
              			©2016 <?php echo e(session('system')->banquan); ?> 外卖进阶攻略 - <?php echo e(session('system')->beianhao); ?>
	...
	<dh-dialog class="disnone" type='login' height="500" header="登录" show="loginShow" >
		<form class="login-form" novalidate name="loginForm" ng-controller="loginCtrl">
			...
			<div ng-init="showCaptcha=0" ng-if="showCaptcha" class="form-group inline clearfix mb10">
				...
				<label class="fr">
					<dh-captcha change="captchaChange" src="<?php echo e(asset('Shop/images/yzm.gif')); ?>"></dh-captcha>
				</label>
			</div>
	...
	<script>
		...
		<script src="<?php echo e(asset('Shop/js/frontPage.js')); ?>"></script>
		<script>angular.bootstrap(document, ["app"]);</script>
                //注册登陆js文件
                <script src="<?php echo e(asset('Shop/js/qtjs.js')); ?>"></script>
                //商家申请js文件
                <script src="<?php echo e(asset('Shop/js/sjzc.js')); ?>"></script>
		<script>
                           //实时获取用户输入搜索地址
