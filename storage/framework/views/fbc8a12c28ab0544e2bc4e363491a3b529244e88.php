...
<article class="page-container">
	<form action="<?php echo e(URL('Business/dealer-password')); ?>" method="post" class="form form-horizontal" id="form-change-password">
        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账户：</label>
			<div class="formControls col-xs-8 col-sm-9" style="font-size:20px;color:red;"><?php echo e(session('adminuser')->name); ?></div>
		</div>
		<div class="row cl">
