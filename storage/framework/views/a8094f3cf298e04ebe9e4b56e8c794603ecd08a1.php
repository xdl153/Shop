...
<div class="page-container">
  ...
  <div class="text-c">
    ...
    <table class="table table-border table-bordered table-bg table-sort">
      ...
      <tbody>
          <tr class="text-c">
          <?php $__currentLoopData = $product_category_reviewed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                 <td width="25"><input type="checkbox" name="" value=""></td>
                 <td><?php echo e($p->id); ?></td>
                 <td><?php echo e($p->cid); ?></td>
                 <td><?php echo e($p->bid); ?></td>
                 <td><?php echo e($p->name); ?></td>
                 <td><?php echo e($p->images); ?></td>
                 <td><?php echo e($p->price); ?></td>
                 <td><?php echo e($p->caipin); ?></td>
                 <td><?php echo e($p->recommend); ?></td>
