...
<html  >
    ...
    <header class="nav clearfix">
        ...
        <div class="fl clearfix nav-des">
            ...
            <div class="fl nav-des-text">
                <h2 class="ellipsis" title="<?php echo e($b->name); ?>"><?php echo e($b->name); ?></h2>
                <div class="clearfix">
        ...
        <div class="fr clearfix nav-right">
            ...
            <?php if(session('userid')): ?>
                ...
                <div class="fl nav-right-collect line-left">
                    <div class="collect collect" onclick="qsc(<?php echo e($_GET['bid']); ?>)" title="取消收藏"></div>
                    <div class="collect-success">收藏成功</div>
                    <div id="review-text">已收藏</div>
                </div>
                <?php else: ?>
                <div class="fl nav-right-collect line-left">
                    <div class="collect not-collect" onclick="sc(<?php echo e($_GET['bid']); ?>)" title="收藏店铺"></div>
                    <div class="collect-success">收藏成功</div>
    ...
    <ul class="clearfix menu-nav-list" scroll-position-static="160">
        ...
        <li class="active"><a href="<?php echo e(URL('/shop_detail')); ?>?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>">菜单</a></li>
        <li ><a href="<?php echo e(URL('/shop_comment')); ?>?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>">评论</a></li>
            ...
            <section class="main-box clearfix" lazy-img-load>
                    ...
                    <div class="inner-main">
                        <nav class="menu-nav link fs12 clearfix" scroll-position-static="130">
                            <ul class="fl" menutoggle>
                                ...
                                <?php $__currentLoopData = $coun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <li data-toggle="section-10">
                                        <a href="javascript:void(0);">店主推荐(<?php echo e($c->c); ?>)</a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>    
				...
				<?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <li title="<?php echo e($m->name); ?>" class="menu-item hasImg" accessorykey="<?php echo e($m->bid); ?>-<?php echo e($m->id); ?>" data-sale="8" data-price="<?php echo e($m->price); ?>">
                                           
                                            <div class="menu-item-img">  
                                                <img data-src="" src="<?php echo e(asset('Shop/')); ?><?php echo e($m->images); ?>"  width="202" height="202" /> 
                                                
                                            </div>
                                            <div class="meun-item-name"><span class="ellipsis"><?php echo e($m->name); ?></span></div>
...
//                                alert(ad);
        ...
        <script src="<?php echo e(asset('Shop/js/menupage.js')); ?>"></script>
...
//                                  window.location.href="/order?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>";
//                            }
//                        },
//                        error:function(){
//                            alert('失败');
