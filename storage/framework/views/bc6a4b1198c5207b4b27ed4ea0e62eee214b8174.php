...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('Shop/css/reset.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('Shop/css/style.css')); ?>" media="screen" type="text/css" />
...
<script src="<?php echo e(asset('Shop/gg_bd_ad_720x90.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('Shop/follow.js')); ?>" type="text/javascript"></script>
</div>
<div class="col">
  <h1>404</h1>
  <p style="font-size:30px;">听说过几天1024，超哥发种子？不要高洛峰老师的</p>
</div>

  <script src="<?php echo e(asset('Shop/js/jquery.js')); ?>"></script>
