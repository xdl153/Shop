...
<html>
    ...
    <ul class="clearfix menu-nav-list" scroll-position-static="160">
        <li class="no-line active"><a href="<?php echo e(URL('/shop_intro')); ?>?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>">餐厅介绍</a></li>
        <li><a href="<?php echo e(URL('/shop_detail')); ?>?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>">菜单</a></li>
        <li  class=""><a href="<?php echo e(URL('/shop_comment')); ?>?bid=<?php echo e($_GET['bid']); ?>&id=<?php echo e($_GET['id']); ?>">评论</a></li>
    ...
    <script>
        ...
        <script>
            ...
            function map_init(){
                var r_pos = new AMap.LngLat(116.35138795770264,40.080606384518376);
