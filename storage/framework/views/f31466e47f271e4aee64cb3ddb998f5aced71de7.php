		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td>number</td>
					<td class="text-1">绝味龙虾</td>
					<td class="text-l">留言content</td>
					<td class="text-l">钱money</td>
					<td class="text-l"> 回龙观IT兄弟连</td>
					<td class="text-l">18515197094</td>
					<td class="text-l">谭伟</td>
					<td class="text-l">货到付款</td>

					<td class="text-l">已送出express</td>
					<td class="f-14 product-brand-manage"><a style="text-decoration:none" onClick="product_brand_edit('发货','<?php echo e(URL('codeing')); ?>','1')" href="javascript:;" title="发货"><i class="Hui-iconfont">&#xe669;</i></a> <a style="text-decoration:none" onClick="product_brand_edit('编辑','codeing.html','1')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="active_del(this,'10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
