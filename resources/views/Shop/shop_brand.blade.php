...
<html>
    ...
    <body class="day " ng-controller="bodyCtrl" ng-controller="restaurantCtrl" day-or-night>
                    ...
                    <div class="common-width clearfix">
                        <h1 class="fl">
                            ...
                            <ul class="member logging" ng-init="loginInfo=true">
                                ...
                                <li class="userName">
                                    <a href="{{ URL('/shop_brand') }}" rel="nofollow" draw-user>18005151538<em></em></a>
                                    <div>
        ...
        <section class="common-width">
             <header class="header clearfix back-tan fs14">
                ...
                <div class="landing-banner">
                    <img src="{{ asset('Shop/images/xianyuxian.jpg') }}" />
                </div>
            ...
            <section class="restaurant-main common-width" lazy-img-load>
                ...
                <ul class="clearfix">
                        ...
                        <li class="restaurant-item fl">
                            <div class="img-box fl">
                                <a href="{{ URL('/shop_detail') }}">
                                    <img src="http://dhcrestaurantlogo.dhero.cn/2816?v=1402216533" width="82px" height="82px">
                                </a>
                            </div>
                        ...
                        <li class="restaurant-item fl">
                            <div class="img-box fl">
                                <a href="shop_detail.html">
                                    <img src="http://dhcrestaurantlogo.dhero.cn/1427?v=1402216533" width="82px" height="82px">
                                </a>
                            </div>
                            <article class="restaurant-introduce fl">
                                <h3 class="ellipsis"><a href="{{ URL('/shop_detail') }}">鲜芋仙 (南方商城店)</a></h3>
                                <dl class="clearfix">
                                    <dt class="fl">饮料小吃</dt>
                                    <dd class="small-star fl">
                        ...
                        <li class="restaurant-item fl">
                            ...
                            <article class="restaurant-introduce fl">
                                <h3 class="ellipsis"><a href="{{ URL('/shop_detail') }}">鲜芋仙 (古美路店)</a></h3>
                                <dl class="clearfix">
                                    <dt class="fl">饮料小吃</dt>
                                    <dd class="small-star fl">
                                        <div class="small-star score" style="width:52.00px"></div>
                        ...
                        <li class="restaurant-item fl">
                            ...
                            <article class="restaurant-introduce fl">
                                <h3 class="ellipsis"><a href="{{ URL('/shop_detail') }}">鲜芋仙 (川沙店)</a></h3>
                                <dl class="clearfix">
                                    <dt class="fl">饮料小吃</dt>
                                    <dd class="small-star fl">
                                        <div class="small-star score" style="width:52.00px"></div>
                ...
                <ul class="clearfix">
                        ...
                        <li class="restaurant-item fl">
                            <div class="img-box fl">
                                <a href="shop_detail.html">
                                    <img src="http://dhcrestaurantlogo.dhero.cn/2978?v=1402216533" width="82px" height="82px">
                                </a>
                            </div>
                            <article class="restaurant-introduce fl">
                                <h3 class="ellipsis"><a href="{{ URL('/shop_detail') }}">鲜芋仙 (吴江路店)</a></h3>
                                <dl class="clearfix">
                                    <dt class="fl">饮料小吃</dt>
                                    <dd class="small-star fl">
                                        <div class="small-star score" style="width:52.00px"></div>
        ...
        <script src="{{ asset('Shop/js/landing.js') }}"></script>
