...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('Shop/css/reset.css') }}">

    <link rel="stylesheet" href="{{ asset('Shop/css/style.css') }}" media="screen" type="text/css" />
...
<script src="{{ asset('Shop/gg_bd_ad_720x90.js') }}" type="text/javascript"></script>
<script src="{{ asset('Shop/follow.js') }}" type="text/javascript"></script>
</div>
<div class="col">
  <h1>404</h1>
