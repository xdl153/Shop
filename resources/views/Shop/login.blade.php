...
<div class="friendly_link">
    ...
    <div class="footer-last">
        ...
        <div class="tc h37">
            <a href="https://www.sgs.gov.cn/lz/licenseLink.do?method=licenceView&entyId=dov73ne26zbqq0ilalaocad1abxr7hlamp" target="_blank"><img src="{{ asset('Shop/static/desktop/img/ft_1.png') }}" alt=""></a>
        </div>
    </div>
</footer>
...
<script type="text/javascript" src="{{ asset('Shop/static/js/module/loginVaildate.js') }}"></script>

<!-- Baidu Analytics -->
<script type="text/javascript">
var _bdhmProtocol = (("https:" == document.location.protocol) ? " https://" : " http://");
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "{{ asset('Shop/static/js/bd.js') }}' type='text/javascript'%3E%3C/script%3E"));
</script>
