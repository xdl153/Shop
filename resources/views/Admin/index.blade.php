...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{ URL('/index') }}">外卖超人后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 添加 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加用户','{{ URL('/article-add') }}')"><i class="Hui-iconfont">&#xe616;</i> 用户</a></li>
							<li><a href="javascript:;" onclick="member_add('添加管理员','{{ URL('/admin-add') }}','','510')"><i class="Hui-iconfont">&#xe60d;</i> 管理员</a></li>
						</ul>
					</li>
				</ul>
			</nav>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="{{ URL('picture-list') }}" data-title="用户反馈" href="javascript:void(0)">用户反馈</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>    
					...
					<li><a _href="{{ URL('product-business') }}" data-title="店铺审核" href="javascript:void(0)">店铺待审核</a></li>
					<li><a _href="{{ URL('product-businesson') }}" data-title="店铺审核已通过" href="javascript:void(0)">店铺审核已通过</a></li>
					<li><a _href="{{ URL('product-businessoff') }}" data-title="店铺审核不通过" href="javascript:void(0)">店铺审核不通过</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="{{ URL('category-list') }}" data-title="类别列表" href="javascript:void(0)">类别列表</a></li>
					<li><a _href="{{ URL('category-add') }}" data-title="添加类别" href="javascript:void(0)">添加类别</a></li>
				</ul>
			</dd>
		</dl>
