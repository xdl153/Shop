...
<article class="page-container">
	<form action="{{ URL('/menu-brand_update') }}" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
...
<!--		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-3"> <span class="select-box">
                                <input type="text" class="select" size="1" value="{{ $s->name }}" name="cname" placeholder="请修改您需要的菜名">
				</span> 
			</div>
		</div>
                <div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-3"> <span class="select-box">
                                <input type="text" class="select" size="1" value="{{ $s->price }}" name="price"  placeholder="请修改金额">
				</span> 
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="btn-upload form-group">
				...
				<input type="file" name="file" value="{{ $s->images }}"  multiple  class="input-file">
				</span> 
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-5 col-sm-5">
				<textarea name="beizhu" cols="" rows="" class="textarea"  placeholder="请您修改菜品" onKeyUp="textarealength(this,100)">{{ $s->caipin }}</textarea>
