...
<html> 
    ...
    <body>
        ...
        <div class="page-container">
                ...
                <div class="cl pd-5 bg-1 bk-gray mt-20">  <span class="r">共有数据：<strong>@foreach($co as $c){{ $c->count }}@endforeach</strong> 条</span> </div>
                <div class="mt-20">
...
<!--                                                <td>12</td>-->
                                                ...
                                                <td>{{ $l->price }}</td>
                                                <td class="zt" name="a{{ $l->mid }}">{{ $l->recommend == '1' ? '上架' : '下架' }}</td>
                                                <input type='hidden' name="a{{ $l->mid }}" value="{{ $l->recommend }}">
                                                <td class="f-14 product-brand-manage">
                                                    @if($l->recommend == '2')
                                                        <a style="text-decoration:none" class="ml-5 tj"  href="javascript:fun({{ $l->mid }});" title="上架">
                                                            <i class="Hui-iconfont">&#xe6dc;</i>
                                                        </a> 
                                                    @else
                                                         <a style="text-decoration:none" class="ml-5 tj"  href="javascript:fun({{ $l->mid }});" title="下架">
                                                            <i class="Hui-iconfont">&#xe6de;</i>
                                                        </a> 
                                                    @endif
